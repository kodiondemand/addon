...
def replay_channels(item):
    ...
    itemlist.append(item.clone(title=support.typo('TG La7', 'bold'), fulltitle='TG La7',
                               ...
                               thumbnail='https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/TGLA7.svg/1200px-TGLA7.svg.png',
                               fanart='https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/TGLA7.svg/1200px-TGLA7.svg.png'))
    return itemlist
